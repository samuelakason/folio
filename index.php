					   				...
					   				<div class="slider-text-inner">
					   					<div class="desc">
						   					<h1>I'm a <br> Web Developer</h1>
												<p><a class="btn btn-primary btn-learn" href="#mywork">View Portfolio <i class="icon-briefcase3"></i></a></p>
											</div>
					   				</div>
					   			</div>
					   		</div>
...
<!-- 									            	<p>During this course, i was able to </p> -->
			...
			<section class="colorlib-work" data-section="work">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<span class="heading-meta" id="mywork">My Work</span>
							...
							<div class="project" style="background-image: url(images/smssch.png);">
								<div class="desc">
									<div class="con">
										...
										<span>This Is A Bulk SMS Sender APP That instantly Sends Messages And Can Also Be Used To Send Bulk Sms At A Future Time. This app consumes an API from smartsmssolutions.com. The API Documentation can be found here https://developer.smartsmssolutions.com/</span>
										<p class="icon">
